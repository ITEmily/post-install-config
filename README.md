...
Step 1: Configure Roles, Departments, and Teams. First, configure ROLES by clicking on Admin Panel -> Agents -> Roles. Name the new role "Supreme Admin."
  Next, configure DEPARTMENTS by clicking on Admin Panel -> Agents -> Departments. Name the new department "System Administrators. Finally, configure TEAMS by clicking Admin Panel -> Agents -> Teams. "Level I Support" is already listed, but add a new team nameed "Level II Support." 
</p>
<br />
